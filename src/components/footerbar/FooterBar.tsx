...
export default function FooterBar({ scrollRef }: FooterBarProps) {
  ...
  return (
    <div className='w-full h-[210px] lg:h-[440px] py-4 text-gray-300 bg-[#121317] flex items-center justify-between px-[30px]'>
      <div className='lg:border-r-2 text-[15px] lg:text-[18px] border-gray-300 border-dashed pr-10 gap-4 h-[75%] flex flex-col items-start justify-center'>
        <a
          href={url_wpp}
          target="_blank"
      ...
      <img className='w-[100px] hidden lg:block' src="acua_logo.png" alt="AcuaLogo" />

      <div className='border-l-2 border-gray-300 border-dashed lg:pt-5 pl-5 lg:pl-10 gap-4 h-[75%] flex justify-center flex-col'>
        {pages.map((page) => (
