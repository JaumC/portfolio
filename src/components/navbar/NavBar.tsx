...
export default function NavBar({ onScroll, activeSection }: NavBarProps) {
  ...
  return (
    <div className={`font-pixelify-sans bg-zinc-900 trasition-transform duration-300 border-b-2 ${activeSection === "home" ? "hidden" : "flex"} rounded-b-xl border-zinc-600 w-full h-[125px] lg:h-[80px] flex-col lg:flex-row items-center justify-between lg:px-[30px] px-[15px]`}>
