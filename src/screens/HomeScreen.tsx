...
export default function HomeScreen() {
  ...
  return (
    <div className="w-full h-[100svh] flex flex-col">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-scroll snap-y snap-mandatory hide-scrollbar">
        {pages.map((page, index) => {
          return (
            <section key={index} id={page} className="snap-start h-[100svh] scroll-mt-20 flex items-center justify-center">
              {pagesComponents[page]}
            </section>
          )
        })}
        <section className="snap-start h-[100svh] scroll-mt-20 flex items-end justify-center">
          <FooterBar />
        </section>
      </div>
    </div>
